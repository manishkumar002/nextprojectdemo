        ...
        <div className="col-sm-8">
          ...
          <div className="col-sm-6 bc2 m-3">
            ...
            <div className="col-sm-6 bg-dark">
                <button
                      ...
                      <p style={{ fontSize: "20px",marginTop:'30px',color:'white',fontFamily:'sofia'}}>
                        <b>
                        Embrace Luxury Living with our Couches
                        </b>
                      </p>
                      <p style={{fontSize:'14px',color:'white',marginTop:'70px' }}>
          ...
          <div className="row">
                ...
                <button
                      ...
                      <p style={{fontSize:'14px' , marginTop:'70px',color:'white'}}>
                        Read more <i class="bi bi-chevron-right"></i>
                      </p>
                </div>
            </div>
