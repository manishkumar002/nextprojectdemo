...
function page(){
  ...
  const calculateRangeStyles = () => {
    ...
    return(
        ...
        <div className='row'>
      <div className='sd'>
        <p className='sd1 mt-5'><b>Shop Top Filters</b></p>
        <p className='sd2'>Home Shop Standard</p>
          </div>
          <button className="bdtt2">BOTTLE <i class="bi bi-x-lg"></i></button>
          <button className="bdtt22">BOTTLE <i class="bi bi-x-lg"></i></button>
          <button className="bdtt3">BEGS <i class="bi bi-x-lg"></i></button>
          <button className="bdtt4">Showing 1–5 Of 50 Results</button>
          <button className="bdtt1"><i class="bi bi-sliders"></i>&nbsp;&nbsp;&nbsp;Filter</button>

          <select className="bdtt5">
  ...
  <select className="bdtt6">
    ...
    <option value="audi">Audi</option>
          ...
          <button className="bdtt7 fs-4" onClick={() => handleButtonClick('manish')}><i class="bi bi-grid-3x3-gap-fill"></i></button>
          <button className="bdtt8 fs-4" onClick={() => handleButtonClick('vijay')}><i class="bi bi-grid-fill"></i></button>
          <button className="bdtt9 fs-5  ms-1"  onClick={() => handleButtonClick('yash')}><i class="bi bi-grid-1x2-fill"></i></button>
          <button className="bdtt9 fs-3"  onClick={() => handleButtonClick('dilip')}><i class="bi bi-grid-3x2-gap-fill"></i></button>
...
<div className='row'>
  ...
  <figure className="snip1268">
                <div className="image">
                  ...
                  <img
                    src="https://mooncart.dexignzone.com/xhtml/images/shop/product/2.png" style={{height:'350px'}}
                    alt="sq-sample4"
                  width="100%"/>
                 <div className="add-to-cart">
                 <center><button
  ...
  <figure className="snip1268">
                <div className="image">
                  ...
                  <img
                    src="https://mooncart.dexignzone.com/xhtml/images/shop/product/3.png" style={{height:'350px'}}
                    alt="sq-sample4"
                  width="100%"/>
                 <div className="add-to-cart">
                 <center><button
  ...
  <figure className="snip1268">
                <div className="image">
                  ...
                  <img
                    src="https://mooncart.dexignzone.com/xhtml/images/shop/product/4.png" style={{height:'350px'}}
                    alt="sq-sample4"
                  width="100%"/>
                 <div className="add-to-cart">
                 <center><button
  ...
  <figure className="snip1268">
                <div className="image">
                  ...
                  <img
                    src="https://mooncart.dexignzone.com/xhtml/images/shop/product/5.png" style={{height:'350px'}}
                    alt="sq-sample4"
                  width="100%"/>
                 <div className="add-to-cart">
                 <center><button
